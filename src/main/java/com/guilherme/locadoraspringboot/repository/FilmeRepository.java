...
public interface FilmeRepository extends JpaRepository<Filme, Integer> {
    ...
    @Query("SELECT new com.guilherme.locadoraspringboot.dto.filme.FilmeDisponivelDTO(f.id, f.titulo, d.nome, count(f)) " +
    ...
    List<FilmeDisponivelDTO> listarDisponiveis();

    List<Filme> findByTituloIgnoreCaseIsLike(String titulo);
}
